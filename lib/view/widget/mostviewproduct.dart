...
class MostViewProduct extends StatefulWidget {
  const MostViewProduct({super.key});

  @override
  State<MostViewProduct> createState() => _MostViewProductState();
}

class _MostViewProductState extends State<MostViewProduct> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: apiService.getMostViewProducts(),
                  ...
                  ? SizedBox(
                      ...
                      child: GridView.builder(
                          ...
                          itemBuilder: ((context, index) {
                            ...
                            String url =
                                "http://172.18.10.88/agrii-ku/data/images/product/";
                            return InkWell(
                              onTap: () {
                                Navigator.push(
                                    context,
